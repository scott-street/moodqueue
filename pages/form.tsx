...
import { Box, Heading, Card, CardHeader, CardBody, CardFooter, Button, Text, Avatar } from "grommet"
...
const Form: FunctionComponent<FormProps> = (props) => {
    const greeting = "hello, " + (props.user.name ? props.user.name.toLowerCase() : "friend")
    return (
                ...
                >
                    ...
                    <CardBody align="center" justify="between" pad="small">
                        <Text textAlign="center">
                            create a public or private playlist of songs based on a mood of your
                            choosing
                        </Text>
                        <Button
                            label="continue"
